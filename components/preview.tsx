...
export default function Preview(): JSX.Element{
  ...
  return(
    ...
    <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] h-auto sm:min-h-[calc(100dvh-72px)]">
      <form className="md:border-r-2 md:border-r-gray-100 md:max-w-[500px] lg:max-w-[700px] xl:max-w-[900px] 2xl:max-w-[1100px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 px-5 gap-4">
          <div className="">
            ...
            <input id="full_name" className="rounded-sm w-full focus:outline-1 focus:outline-gray-600 mt-3 block p-2 border-1 border-gray-200" type="text" />
          </div>
          <div>
            <label htmlFor="print-size" className="text-sm sm:text-lg text-gray-700 font-medium">Emirate</label>
            <select className="block w-full h-[42px] px-2 border-1 mt-3 rounded-sm border-gray-200">
          ...
          <div className="">
            <label className="text-sm sm:text-lg text-gray-700 font-medium" htmlFor="emirate">Emirate</label>
            <input id="emirate" className="rounded-sm w-full mt-3 block p-2 outline-none border-1 border-gray-200" type="text" />
          </div>
          <div className="">
            <label className="text-sm sm:text-lg text-gray-700 font-medium" htmlFor="first_name">First Name</label>
            <input className="rounded-sm w-full mt-3 block p-2 outline-none border-1 border-gray-200" type="text" />
          </div>
        </div>
        ...
        <div className="flex flex-col sm:items-center justify-between sm:flex-row items-start">
          ...
          <div className="px-5 w-full sm:w-auto mt-5 sm:mt-0">
            <Button type="submit" className="px-6 py-3 w-full sm:w-auto">Pay</Button>
          </div>
        </div>
      </form>
      ...
      <div className="h-auto sm:min-h-[calc(100dvh-72px)] flex items-center justify-center pb-4">
        <h3 className="hidden sm:block">Upload photos and View your Order here</h3>
      </div>
      }
    </div>
    </>
